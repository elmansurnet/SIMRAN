  ...
  <AppLayout :title="disbursement.name">
      ...
      <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        <div>
          <div class="flex items-center space-x-2 mb-1">
            ...
            <Badge
              :color="disbursement.status === 'active' ? 'green' : disbursement.status === 'expired' ? 'gray' : 'blue'"
              :dot="true"
            >
        ...
        <div class="flex flex-wrap gap-2 shrink-0">
          ...
          <!-- ✅ Uses shared route — no role prefix needed -->
          <a
            :href="route('disbursements.report', disbursement.id)"
            target="_blank"
    ...
    <div class="card animate-fade-in-up" style="animation-delay:360ms">
      ...
      <div v-if="disbursement.transactions?.length" class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-100">
          ...
          <tbody class="divide-y divide-gray-50 bg-white">
            <tr
              v-for="(t, i) in disbursement.transactions"
              :key="t.id"
            ...
            >
              ...
              <Td>
                <!-- ✅ Uses shared route — works for admin too -->
                <a
                  v-if="t.has_proof"
                ...
                >
                  ...
                  <span class="truncate max-w-[100px]">{{ t.proof_name }}</span>
                </a>
      ...
      <EmptyState
        ...
        description="Belum ada transaksi yang dicatat untuk pencairan ini."
      />
    </div>
  </AppLayout>
</template>
